...
extension AppTextStyleExtensions on Text {
  Widget bodySmall({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
  ...
  Widget bodyMedium({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
  ...
  Widget bodyLarge({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
      selector: (t) => t.bodyLarge!,
      textAlign: textAlign,
  ...
  Widget labelSmall({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
  ...
  Widget labelMedium({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
      selector: (t) => t.labelMedium!,
      textAlign: textAlign,
  ...
  Widget labelLarge({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
  ...
  Widget titleSmall({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
  ...
  Widget titleMedium({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
      selector: (t) => t.titleSmall!,
      textAlign: textAlign,
  ...
  Widget titleLarge({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return AppText(
      data ?? "",
      selector: (t) => t.titleSmall!,
      textAlign: textAlign,
...
extension StyledText<T extends Text> on T {
  ...
  T fontWeight(final FontWeight fontWeight) => copyWith(style: (style ?? const TextStyle()).copyWith(fontWeight: fontWeight)) as T;
  ...
  T textShadow({final Color color = const Color(0x34000000), final double blurRadius = 0.0, final Offset offset = Offset.zero}) =>
      copyWith(
  ...
  T textBaseline(final TextBaseline textBaseline) => copyWith(style: (style ?? const TextStyle()).copyWith(textBaseline: textBaseline)) as T;
